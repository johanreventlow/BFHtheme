...
BFHtheme supports both Bispebjerg og Frederiksberg Hospital and Region
Hovedstaden branding. This vignette shows how to choose palettes, scales, and
defaults that match the audience for each deliverable.
...
Hospital-level materials emphasise bright blues with light neutrals. Use these
palettes for BFH internal reports, departmental dashboards, and patient-facing
content.
...
For visualisations that map magnitude or rank, use the hospital sequential
palettes:
...
Regional gradients emphasise the darker navy tones while maintaining legible
steps for heatmaps and surface plots.
...
Use infographic palettes when you need many clearly differentiated categories.
They balance the brand primaries with supportive neutrals.
...
Maintain consistent styling when comparing multiple sites by mapping each site
to a predefined brand colour:
...
- Use: Main brand colour, primary data series
...
- Use: Main brand colour for regional reporting
